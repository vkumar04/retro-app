...
import { StatsPanel } from "@/app/_components/admin/stats-panel"
      ...
      <main className="p-4 md:p-6 max-w-5xl mx-auto">
        {lastError && (
          <div className="mb-4 border border-destructive/60 bg-destructive/10 text-destructive px-3 py-2 text-xs tracking-wider">
            ...
            <div className="text-destructive/80 font-normal break-words">{lastError}</div>
            {isQuotaError && (
        ...
        <Tabs defaultValue="controls" className="gap-4">
          <TabsList className="bg-card border border-border">
            <TabsTrigger value="controls" className="tracking-wider text-xs">
              CONTROLS
            </TabsTrigger>
          ...
          <TabsContent value="controls">
            <ControlsPanel mood={mood} systemStatus={systemStatus} />
          </TabsContent>
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <div className="md:col-span-2">
        <Panel title="TASKS" right={`${completedCount} / ${todos.length} DONE`}>
